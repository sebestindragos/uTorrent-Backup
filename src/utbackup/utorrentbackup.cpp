...
// 
// bool uTorrentBackup::Cleanup()
// {
//   try
//   {
//     mWorkerFunc = std::bind(&uTorrentBackup::DoCleanup, this);
//     StartWorkerThread();
//   }
//   CATCH_EVERYTHING;
// 
...
// }
// 
// bool uTorrentBackup::DoCleanup()
// {
//   UIManager::Get().DisplayStatusMessage(L"Working ...");
//   WinTaskbar::Get().SetProgressState(UIManager::Get().GetWindow(), WinTaskbar::Indeterminate);
// 
//   // get a list of the active torrents
//   FilePath resumeFilePath(mPropertyPool.GetProperty(UT_PATH_PROP) + Globals::kUtSettingsFile);
...
//   for (; it != end; ++it)
//   {
//     activeTorrents.push_back((*it)->GetLabel());
//   }
// 
//   // get a list with the torrent files
//   vector<wstring> files;
//   FilePath utPath = mPropertyPool.GetProperty(UT_PATH_PROP);
//   FileUtil::ListDirectoryContents(utPath.Get(), files, false, L"torrent");
//   if (mPropertyPool.GetProperty(UT_ALTERNATEFOLDER_PROP) == PROP_TRUE)
//   {
//     FilePath altPath = mPropertyPool.GetProperty(UT_ALTERNATEFOLDERPATH_PROP);
//     FileUtil::ListDirectoryContents(altPath.Get(), files, false, L"torrent", true);
//   }
// 
...
//   {
//     // if the file is not one of the active torrents, delete it
//     if (find(activeTorrents.begin(), activeTorrents.end(), *filesIt) == activeTorrents.end())
//     {
//       deletedFilesCount++;
//       if (::PathFileExists(filesIt->c_str()))
//         ::DeleteFile(filesIt->c_str());
//       else
//         ::DeleteFile((utPath + *filesIt).Get().c_str());
//     }
//   }
//   
//   wstring status = L"Cleanup complete. ";
//   if (deletedFilesCount == 0)
//     status += L"The system is clean.";
//   else
//     status += L"Removed " + StringUtil::IntToString(deletedFilesCount) + L" files.";
//     
//   UIManager::Get().DisplayStatusMessage(status.c_str());
//   WinTaskbar::Get().SetProgressState(UIManager::Get().GetWindow(), WinTaskbar::NoProgress);
// 
//   return true;
// }
